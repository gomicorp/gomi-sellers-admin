ActiveAdmin.register Sellers::SettlementStatement, as: 'Settlement' do
  ...
  show title: '출금 정보' do
    unless settlement.stamped?
      div do
        span link_to '승인', accept_settlement_path(settlement), method: :put, class: 'action-btn primary'
        span link_to '거절', reject_settlement_path(settlement), method: :put, class: 'action-btn'
      end
    end
